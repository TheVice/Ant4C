...
uint8_t BLAKE3_core(
	const uint8_t* input, uint64_t length,
	uint32_t* m, uint8_t* l, uint32_t* h,
	uint8_t* compressed, uint32_t* t,
	uint8_t* stack, uint8_t* stack_length, uint8_t d);
uint8_t BLAKE3_final(
	const uint8_t* stack, uint8_t stack_length,
